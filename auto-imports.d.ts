...
export {}
declare global {
  const AlertDialog: typeof import('./src/components/ui/alert-dialog/index')['AlertDialog']
  const AlertDialogAction: typeof import('./src/components/ui/alert-dialog/index')['AlertDialogAction']
  const AlertDialogCancel: typeof import('./src/components/ui/alert-dialog/index')['AlertDialogCancel']
  const AlertDialogContent: typeof import('./src/components/ui/alert-dialog/index')['AlertDialogContent']
  const AlertDialogDescription: typeof import('./src/components/ui/alert-dialog/index')['AlertDialogDescription']
  const AlertDialogFooter: typeof import('./src/components/ui/alert-dialog/index')['AlertDialogFooter']
  const AlertDialogHeader: typeof import('./src/components/ui/alert-dialog/index')['AlertDialogHeader']
  const AlertDialogTitle: typeof import('./src/components/ui/alert-dialog/index')['AlertDialogTitle']
  ...
  const gameStore: typeof import('./src/stores/game')['gameStore']
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    readonly AlertDialog: UnwrapRef<typeof import('./src/components/ui/alert-dialog/index')['AlertDialog']>
    readonly AlertDialogAction: UnwrapRef<typeof import('./src/components/ui/alert-dialog/index')['AlertDialogAction']>
    readonly AlertDialogCancel: UnwrapRef<typeof import('./src/components/ui/alert-dialog/index')['AlertDialogCancel']>
    readonly AlertDialogContent: UnwrapRef<typeof import('./src/components/ui/alert-dialog/index')['AlertDialogContent']>
    readonly AlertDialogDescription: UnwrapRef<typeof import('./src/components/ui/alert-dialog/index')['AlertDialogDescription']>
    readonly AlertDialogFooter: UnwrapRef<typeof import('./src/components/ui/alert-dialog/index')['AlertDialogFooter']>
    readonly AlertDialogHeader: UnwrapRef<typeof import('./src/components/ui/alert-dialog/index')['AlertDialogHeader']>
    readonly AlertDialogTitle: UnwrapRef<typeof import('./src/components/ui/alert-dialog/index')['AlertDialogTitle']>
